...
Blockly.Blocks.lists_getIndex = {
    init: function() {
        ...
        this.setStyle("list_blocks");
        a = new Blockly.FieldDropdown(a, function(a) { this.sourceBlock_.updateStatement_("REMOVE" == a) });
    ...
    onchange: function() {
        if (this.workspace.isDragging && !this.workspace.isDragging()) {
            var a = !1,
                b = this;
            do {
                if (-1 != this.LOOP_TYPES.indexOf(b.type)) { a = !0; break }
...
Blockly.Constants.Math.IS_DIVISIBLE_MUTATOR_EXTENSION = function() { this.getField("PROPERTY").setValidator(function(a) { this.sourceBlock_.updateShape_("DIVISIBLE_BY" == a) }) };
...
Blockly.Blocks.procedures_defnoreturn = {
    ...
    updateVarName: function(a) {
        for (var b =
                a.name, c = !1, d = 0; d < this.argumentVarModels_.length; d++)
...
Blockly.Blocks.procedures_mutatorarg = {
    ...
    validator_: function(a) {
        ...
        if (!a) return null;
        for (var c = this.sourceBlock_.workspace.getAllBlocks(), d = 0; d < c.length; d += 1)
            if (c[d].id != this.sourceBlock_.id && c[d].getFieldValue("NAME") == a) return null;
