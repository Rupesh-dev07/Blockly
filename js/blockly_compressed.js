...
goog.color.blend = function(a, b, c) { c = goog.math.clamp(c, 0, 1); return [Math.round(b[0] + c * (a[0] - b[0])), Math.round(b[1] + c * (a[1] - b[1])), Math.round(b[2] + c * (a[2] - b[2]))] };
...
goog.labs.userAgent.browser.matchSafari_ = function() { return goog.labs.userAgent.util.matchUserAgent("Safari") && !(goog.labs.userAgent.browser.matchChrome_() || goog.labs.userAgent.browser.matchCoast_() || goog.labs.userAgent.browser.matchOpera_() || goog.labs.userAgent.browser.matchEdgeHtml_() || goog.labs.userAgent.browser.matchEdgeChromium_() || goog.labs.userAgent.browser.matchFirefox_() || goog.labs.userAgent.browser.isSilk() || goog.labs.userAgent.util.matchUserAgent("Android")) };
...
Blockly.utils.removeNode = function(a) { return a && a.parentNode ? a.parentNode.removeChild(a) : null };
...
Blockly.utils.startsWith = function(a, b) { return 0 == a.lastIndexOf(b, 0) };
...
Blockly.utils.toRadians = function(a) { return a * Math.PI / 180 };
Blockly.utils.toDegrees = function(a) { return 180 * a / Math.PI };
...
Blockly.Touch.isMouseOrTouchEvent = function(a) { return Blockly.utils.startsWith(a.type, "touch") || Blockly.utils.startsWith(a.type, "mouse") || Blockly.utils.startsWith(a.type, "pointer") };
Blockly.Touch.isTouchEvent = function(a) { return Blockly.utils.startsWith(a.type, "touch") || Blockly.utils.startsWith(a.type, "pointer") };
...
Blockly.Xml = {};
Blockly.Xml.utils = {};
Blockly.Xml.utils.createElement = function(a) { return document.createElement(a) };
Blockly.Xml.utils.createTextNode = function(a) { return document.createTextNode(a) };
Blockly.Xml.utils.textToDomDocument = function(a) { return (new DOMParser).parseFromString(a, "text/xml") };
Blockly.Xml.utils.domToText = function(a) { return (new XMLSerializer).serializeToString(a) };
...
Blockly.Events.Create.prototype.run = function(a) {
    var b = this.getEventWorkspace_();
    if (a) a = Blockly.Xml.utils.createElement("xml"), a.appendChild(this.xml), Blockly.Xml.domToWorkspace(a, b);
    else {
        a = 0;
...
Blockly.Xml.domToText = function(a) { return Blockly.Xml.utils.domToText(a) };
...
Blockly.Xml.textToDom = function(a) { a = Blockly.Xml.utils.textToDomDocument(a); if (!a || !a.documentElement || "xml" != a.documentElement.nodeName.toLowerCase()) throw TypeError("Blockly.Xml.textToDom expected an <xml> document."); return a.documentElement };
...
Blockly.Xml.domToVariables = function(a, b) {
    for (var c = 0, d; d = a.childNodes[c]; c++)
        if (d.nodeType == Element.ELEMENT_NODE) {
...
Blockly.TouchGesture.prototype.getTouchPoint = function(a) { return this.startWorkspace_ ? new goog.math.Coordinate(a.pageX ? a.pageX : a.changedTouches[0].pageX, a.pageY ? a.pageY : a.changedTouches[0].pageY) : null };
...
Blockly.Trashcan.prototype.init = function(a) {
    0 < this.workspace_.options.maxTrashcanContents && (Blockly.utils.insertAfter(this.flyout_.createDom("svg"), this.workspace_.getParentSvg()), this.flyout_.init(this.workspace_), this.flyout_.isBlockCreatable_ = function() { return !0 });
...
Blockly.Variables.flyoutCategoryBlocks = function(a) {
    ...
    if (0 < a.length) {
        ...
        if (Blockly.Blocks.variables_get)
            for (a.sort(Blockly.VariableModel.compareByName), c = 0; d = a[c]; c++) d = '<xml><block type="variables_get" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(d) + "</block></xml>", d = Blockly.Xml.textToDom(d).firstChild, b.push(d)
    }
    return b
};
...
Blockly.WorkspaceCommentSvg.prototype.setFocus = function() {
    var a = this;
    this.focused_ = !0;
    setTimeout(function() { a.disposed_ || (a.textarea_.focus(), a.addFocus(), Blockly.utils.addClass(a.svgRectTarget_, "blocklyCommentTargetFocused"), Blockly.utils.addClass(a.svgHandleTarget_, "blocklyCommentHandleTargetFocused")) }, 0)
};
Blockly.WorkspaceCommentSvg.prototype.blurFocus = function() {
    var a = this;
    this.focused_ = !1;
    setTimeout(function() { a.disposed_ || (a.textarea_.blur(), a.removeFocus(), Blockly.utils.removeClass(a.svgRectTarget_, "blocklyCommentTargetFocused"), Blockly.utils.removeClass(a.svgHandleTarget_, "blocklyCommentHandleTargetFocused")) }, 0)
};
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(a) {
    ...
    a = Blockly.utils.createSvgElement("image", { width: Blockly.SPRITE.width, height: Blockly.SPRITE.height, x: -64, y: -92, "clip-path": "url(#blocklyZoomoutClipPath" + a + ")" }, this.zoomOutGroup_);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function(a) {
    ...
    Blockly.utils.createSvgElement("rect", { width: 32, height: 32 }, c);
    a = Blockly.utils.createSvgElement("image", { width: Blockly.SPRITE.width, height: Blockly.SPRITE.height, x: -32, y: -92, "clip-path": "url(#blocklyZoominClipPath" + a + ")" }, this.zoomInGroup_);
    a.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", b.options.pathToMedia + Blockly.SPRITE.url);
    Blockly.bindEventWithChecks_(a, "mousedown", null, function(a) {
        b.markFocused();
        b.zoomCenter(1);
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function(a) {
    ...
    Blockly.utils.createSvgElement("rect", { width: 32, height: 32 }, c);
    a = Blockly.utils.createSvgElement("image", { width: Blockly.SPRITE.width, height: Blockly.SPRITE.height, y: -92, "clip-path": "url(#blocklyZoomresetClipPath" + a + ")" },
...
Blockly.WorkspaceSvg.prototype.createDom = function(a) {
    ...
    a && (this.svgBackground_ = Blockly.utils.createSvgElement("rect", { height: "100%", width: "100%", "class": a }, this.svgGroup_), "blocklyMainBackground" == a && this.grid_ && (this.svgBackground_.style.fill = "url(#" + this.grid_.getPatternId() + ")"));
...
Blockly.Mutator.prototype.createEditor_ = function() {
    ...
    if (this.quarkNames_.length)
        for (var a = Blockly.Xml.utils.createElement("xml"), b = 0, c; c = this.quarkNames_[b]; b++) {
...
Blockly.FieldLabel.prototype.dispose = function() { this.textElement_ && (Blockly.utils.removeNode(this.textElement_), this.textElement_ = null) };
...
Blockly.Block.prototype.setColour = function(a) {
    ...
    else if ("string" == typeof b && /^#[0-9a-fA-F]{6}$/.test(b)) this.colour_ = b, this.hue_ = null;
...
Blockly.BlockSvg.prototype.setInsertionMarker = function(a) { this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) && (this.setColour(Blockly.INSERTION_MARKER_COLOUR), Blockly.utils.addClass(this.svgGroup_, "blocklyInsertionMarker")) };
...
Blockly.BlockSvg.prototype.updateColour = function() {
    if (!this.disabled) {
        var a = this.getColour(),
            b = this.getColourSecondary(),
            c = this.getColourTertiary(),
        ...
        for (a = 0; b = this.inputList[a]; a++)
            for (c = 0; d = b.fieldRow[c]; c++) d.forceRerender()
    }
};
Blockly.BlockSvg.prototype.setBorderColour_ = function(a, b) {
    if (b) this.svgPathLight_.setAttribute("stroke", "none"), this.svgPathDark_.setAttribute("fill", "none"), this.svgPath_.setAttribute("stroke", b);
    else {
...
Blockly.BlockSvg.prototype.highlightForReplacement = function(a) { a ? Blockly.utils.addClass(this.svgGroup_, "blocklyReplaceable") : Blockly.utils.removeClass(this.svgGroup_, "blocklyReplaceable") };
/*
...
Blockly.DropDownDiv.repositionForWindowResize = function() {
    if (Blockly.DropDownDiv.owner_) {
        var a = Blockly.DropDownDiv.owner_.sourceBlock_,
            b = a.workspace.scale,
...
Blockly.FieldColour.prototype.getSize = function() { this.size_.width || this.render_(); return this.size_ };
...
Blockly.FieldImage.prototype.init = function() {
    this.fieldGroup_ || (this.fieldGroup_ = Blockly.utils.createSvgElement("g", {}, null), this.visible_ || (this.fieldGroup_.style.display = "none"), this.imageElement_ = Blockly.utils.createSvgElement("image", { height: this.height_ + "px", width: this.width_ + "px" }, this.fieldGroup_), this.setValue(this.src_), this.setText(this.text_), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.tooltip_ ? this.imageElement_.tooltip = this.tooltip_ : this.setTooltip(this.sourceBlock_),
...
Blockly.FieldImage.prototype.maybeAddClickHandler_ = function() { this.clickHandler_ && (this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mousedown", this, this.clickHandler_)) };
...
Blockly.Procedures.rename = function(a) {
    ...
    var b = Blockly.Procedures.findLegalName(a, this.sourceBlock_),
        c = this.text_;
    if (c != a && c != b) { a = this.sourceBlock_.workspace.getAllBlocks(!1); for (var d = 0; d < a.length; d++) a[d].renameProcedure && a[d].renameProcedure(c, b) }
    return b
};
Blockly.Procedures.flyoutCategory = function(a) {
    function b(a, b) {
        for (var d = 0; d < a.length; d++) {
            var e = a[d][0],
                f = a[d][1],
                g = Blockly.Xml.utils.createElement("block");
...
Blockly.Flyout.prototype.isBlockCreatable_ = function(a) { return !a.disabled };
...
Blockly.Flyout.prototype.filterForCapacity_ = function() {
    for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++)
        if (-1 == this.permanentlyDisabled_.indexOf(c))
            for (var d = !this.targetWorkspace_.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(c)); c;) c.setDisabled(d), c = c.getNextBlock()
};
...
Blockly.refreshTheme_ = function(a) {
    this.updateBlockStyles_(a.getAllBlocks().filter(function(a) { return void 0 !== a.getStyleName() }));
...
Blockly.getTheme = function() { return this.theme_ };
goog.global.Blockly || (goog.global.Blockly = {});
